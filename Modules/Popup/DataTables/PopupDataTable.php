    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->editColumn('name', function ($popup) {
                ...
                $edit = '<a title="' . __('Edit :?', ['?' => __('popup')]) . '" href="' . route('popup.edit', ['id' => $popup->id]) . '" class="btn btn-xs btn-primary"><i class="feather icon-edit neg-transition-scale-svg "></i></a>&nbsp';
