    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->editColumn('username', function ($sub) {
                ...
                $edit = '<a title="' . __('Edit :x', ['x' => __('Submission')]) . '" href="' . route('formbuilder::kyc.sub-edit', [$sub->id]) . '" class="btn btn-xs btn-primary"><i class="feather icon-edit neg-transition-scale-svg " aria-hidden="true"></i></a>&nbsp';
