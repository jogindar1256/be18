                ...
                <div class="d-md-flex mt-2 mt-md-0">
                    <div role="toolbar">
                        <div class="btn-group d-flex flex-wrap" role="group">
                            <a href="{{ route('formbuilder::forms.create') }}" class="btn mt-2 mt-sm-0 btn-primary btn-sm mb-0 ltr:me-2 rtl:ms-2">
                                <i class="fa fa-plus"></i> {{ __('Add New Form') }}
                            </a>

                            <a href="{{ route('formbuilder::submissions.all') }}" class="btn mt-2 mt-sm-0 btn-primary mb-0 btn-sm ltr:me-2 rtl:ms-2">
                                <i class="fa fa-th-list neg-transition-scale"></i> {{ __('Submissions') }}
                            </a>
                            <a href="javascript:void(0);" class="btn btn-primary mt-2 mt-sm-0 btn-sm ltr:me-2 rtl:ms-2" data-bs-toggle="collapse"
