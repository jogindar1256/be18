...
<div class="col-sm-12 list-container" id="blog-list-container">
  <div class="card">
    <div class="card-header d-md-flex justify-content-between align-items-center">
      <h5><a href="{{ route('blog.index') }}">{{ __('Blogs') }}</a></h5>
        <div class="d-flex mt-2 mt-md-0">
            ...
            @endif
        <button class="btn btn-outline-primary custom-btn-small mb-0 ltr:me-0 rtl:ms-0 collapsed filterbtn" type="button" data-bs-toggle="collapse" data-bs-target="#filterPanel" aria-expanded="true" aria-controls="filterPanel"><span class="fas fa-filter">&nbsp;</span>{{ __('Filter') }}</button>
    </div>
    </div>
    ...
    <div class="card-body px-4 blog-table need-batch-operation"
      ...
      <div class="card-block pt-2 px-0 all-blogs-table">
        <div class="col-sm-12">
