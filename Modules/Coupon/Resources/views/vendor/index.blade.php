    ...
    <div class="card-header d-md-flex justify-content-between align-items-center">
      <h5><a href="{{ route('vendor.coupons') }}">{{ __('Coupons') }}</a></h5>
        <div class="mt-md-0 mt-2">
            ...
            @endif
            <button class="btn btn-outline-primary custom-btn-small collapsed filterbtn mb-0 ltr:me-0 rtl:ms-0" type="button" data-bs-toggle="collapse" data-bs-target="#filterPanel" aria-expanded="true" aria-controls="filterPanel"><span class="fas fa-filter">&nbsp;</span>{{ __('Filter') }}</button>
        </div>
    </div>
