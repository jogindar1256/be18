    ...
    public function ajax()
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function ($reviews) {
                $edit = '<a title="' . __('Edit') . '" href="' . route('review.edit', ['id' => $reviews->id]) .'" class="btn btn-xs btn-primary edit_review" data-bs-toggle="modal" data-bs-target="#edit-review" data-id=' . $reviews->id . '><i class="feather icon-edit neg-transition-scale-svg "></i></a>&nbsp;';
