        ...
        return datatables()
            ...
            ->addColumn('role', function ($users) {
                ...
                foreach ($users->roles as $role) {
                    $str .= '<p><span class="fas fa-bullseye me-2"></span>' . $role->name . '</p>';
                }
                return $str;
            })
            ...
            ->addColumn('action', function ($users) {
                $edit = '<a title="' . __('Edit') . '" href="' . route('users.edit', ['id' => $users->id]) . '" class="btn btn-xs btn-primary"><i class="feather icon-edit neg-transition-scale-svg "></i></a>&nbsp;';
