...
<body>
    <div class="wrapper">
        ...
        <p>Prior to proceeding, it is imperative to conduct a database upgrade. The current file version stands at <b><?php echo config('martvill.file_version')  ?></b>, whereas the database version is <b><?php echo preference('db_version', '1.0.0') ?></b>.</p>
