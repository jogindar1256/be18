    ...
    @if (!$product->isGroupedProduct())
        <div class="my-4 block mt-5">
            ...
            @if ($product->isExternalProduct())
                ...
                @endif
            @else
                <a href="javascript:void(0)" class="add-to-cart cart-details-page mt-6" id="item-add-to-cart"
                    data-itemCode={{ $code }}>
                    <button class="primary-bg-color font-bold py-2 px-8 rounded flex justify-center items-center">
                        ...
                        <span
                            class="ltr:pl-2 rtl:pr-2 p-5p dm-bold font-bold text-white text-lg">{{ __('Add to Cart') }}</span>
                    </button>
                </a>
            @endif
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <span class="inline-block">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="8" height="2"
                                                ...
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M7.41481 1.40002H0L0 0.259277H7.41481V1.40002Z" fill="#898989" />
                                            </svg>
                                        </span>
                                    </a>
                                    <div
                ...
                <div class="w-full">
                    @if ($isSimpleAvailable)
                        <a href="javascript:void(0)" class="add-to-cart cart-details-page" id="item-add-to-cart">
                            <button
                                class="primary-bg-color font-bold w-full py-2 px-8 rounded flex justify-center items-center">
                                <svg class="text-white" width="20" height="19" viewBox="0 0 20 19"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M5.88135 10C5.32906 10 4.88135 9.55228 4.88135 9L4.88135 5C4.88135 2.23858 7.11992 -1.25946e-06 9.88135 -6.82991e-07C12.6428 -1.0602e-06 14.8813 2.23858 14.8813 5L14.8813 9C14.8813 9.55228 14.4336 10 13.8813 10C13.3291 10 12.8813 9.55228 12.8813 9L12.8813 5C12.8813 3.34315 11.5382 2 9.88135 2C8.22449 2 6.88135 3.34314 6.88135 5L6.88135 9C6.88135 9.55228 6.43363 10 5.88135 10Z"
                                        fill="currentColor" />
