<div class="border rounded-md mt-2 md:mt-0">
    <div class="px-4">
        ...
        <div class="my-4">
            ...
            <a class="flex title-font font-medium items-center md:justify-start text-gray-900 mt-5 mb-5">
                <div>
                    <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <span class="font-bold dm-bold text-base text-gray-12">🧪 {{ __('Our Formulations are-') }}</span>
            <a class="flex title-font font-medium items-center md:justify-start flex-col text-gray-400 mt-2" style="align-items: baseline">
                <span class="text-gray-12 text-15 dm-bold font-400 ltr:ml-2.5 rtl:mr-2.5"> 🥂 Alcohol Free </span>
                <span class="text-gray-12 text-15 dm-bold font-400 ltr:ml-2.5 rtl:mr-2.5"> 🐰 Cruelty Free </span>
                <span class="text-gray-12 text-15 dm-bold font-400 ltr:ml-2.5 rtl:mr-2.5"> 🌱 Vegan </span>
                <span class="text-gray-12 text-15 dm-bold font-400 ltr:ml-2.5 rtl:mr-2.5"> 🚫 Paraben Free </span>
                <span class="text-gray-12 text-15 dm-bold font-400 ltr:ml-2.5 rtl:mr-2.5"> ✅ Dermatology Tested </span>
            </a>
