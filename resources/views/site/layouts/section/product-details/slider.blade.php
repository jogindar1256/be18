                    ...
                    <div class="relative">
                        <div class="absolute z-10 left-3.5 top-3.5">
                            @if ($outOfStock['outOfStockVisibility'] == 1 && !$product->isVariableProduct())
                                ...
                                <p
                                    class="bg-pinks-2 relative z-20 h-4 text-reds-3 mb-2.5 w-max px-1.5 flex items-center rounded-sm leading-3 roboto-medium font-medium pt-2p whitespace-nowrap text-11">
                                    {{ __('Stock Out') }}
                                </p>
                            @endif
