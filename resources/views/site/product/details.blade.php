...
@section('content')
    ...
    <section class="mx-5 lg:mx-4 xl:mx-32 2xl:mx-64 3xl:mx-92 md:mt-30p mt-5" id="item-details-container">
        ...
        <div id="item-details-section" class="flex flex-wrap mt-6">
            <div class="w-full lg:w-82% ltr:lg:pr-3 rtl:lg:pl-3">
                <section class="md:mb-10">
                    <div id="tabs" class="c-tabs">
                        <div class="flex dm-sans">
                            <div class="c-tabs-nav d-tab w-full" id="nav-line">
                                ...
                                <a href="javascript:void(0)" class="c-tabs-nav__link"
                                    id="product-specification">{{ __('Ingredients') }}</a>
                                ...
                                @endphp
                                <a href="javascript:void(0)" class="c-tabs-nav__link"
                                    id="product-faq">{{ __('FAQs') }}</a>

                                {{-- Product Apply (how to apply) --}}
                                {{-- @php $initialTab != 1 ? $initialTab = 5 : '' ;$ratingTab++ @endphp
                            <a href="javascript:void(0)" class="c-tabs-nav__link" id="product-apply">{{ __('How To Apply') }}</a> --}}
                                ...
                                @if ($reviews_allowed == 1 && preference('reviews_enable_product_review') == 1)
                                    @php
                                        $initialTab != 0 && $initialTab != 1 && $initialTab != 2 ? ($initialTab = 4) : '';
                                        $ratingTab++;
                                    @endphp
                                    <a href="javascript:void(0)" class="c-tabs-nav__link"
                        ...
                        @include('site.layouts.section.product-details.faq')
...
@section('js')
    ...
    <script src="{{ asset('public/dist/js/custom/site/product-details.js') }}"></script>
