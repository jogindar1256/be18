        ...
        <div class="card">
            <div class="card-header d-md-flex justify-content-between align-items-center">
                ...
                <div class="d-md-flex mt-2 mt-md-0 justify-content-end align-items-center">
                    ...
                    @endif
                    <button class="btn btn-outline-primary custom-btn-small mb-0 collapsed filterbtn ltr:me-0 rtl:ms-0" type="button"
                        data-bs-toggle="collapse" data-bs-target="#filterPanel" aria-expanded="true"
                        aria-controls="filterPanel"><span class="fas fa-filter ltr:me-1 rtl:ms-1"></span>{{ __('Filter') }}</button>
                </div>
            </div>
