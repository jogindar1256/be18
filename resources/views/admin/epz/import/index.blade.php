                    ...
                    <div class="col-sm-12 row p-0 m-0">
                            ...
                            <div class="card table-card">
                                <div class="row-table">
                                    <div class="col-auto bg-yellow text-black p-t-50 p-b-50">
                                        <i class="feather icon-package f-30 neg-transition-scale"></i>
                                    </div>
                                    <div class="col text-center">
                                        <h3 class="f-w-300">{{ __('Import Products') }}</h3>
                                    </div>
                                </div>
                            </div>
                        </a>
                        <a href="{{ route('epz.import.users') }}" class="col-md-6 col-xl-4">
                            <div class="card table-card">
                                <div class="row-table">
                                    <div class="col-auto bg-yellow text-black p-t-50 p-b-50">
                                        <i class="feather icon-user-plus f-30 neg-transition-scale"></i>
                                    </div>
                                    <div class="col text-center">
                                        <h3 class="f-w-300">{{ __('Import Users') }}</h3>
                                    </div>
                                </div>
                            </div>
                        </a>
